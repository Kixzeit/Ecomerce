      ...
      section_pago.classList.remove("d-flex", "flex-column", "justify-content-around", "align-items-center", "pagar_section_class");
        ...
        carrito_compras.forEach((element,index) =>{
         ...
         // let stock_carrito = element.stock;
          ...
          <div id="contenedor_${index}" class="container_carrito_class container-fluid">
        ...
        <div class="container_descripcion d-flex flex-column fs-2 justify-content-center align-items-center">
          <p>${descripcion_carrito}</p>
        </div>
        <div id="botones_${index}" class="container_cantidad d-flex justify-content-around align-items-center"> 
          <button disabled=true id="bttnmenos_${index}" class="btn btn-outline-success menos">-</button><label class="cantidad fs-2">1</label><button id="bttnmas_${index}" class="btn btn-success mas">+</button>
        </div>
        ...
        /*  cantidad_productos.textContent ="";*/
          ...
          li_home.click();
          titulo_general.textContent="Kixeit'Tech";
        ...
        /* let cantidad_productos = document.getElementById("cantidad_productos");*/
          ...
          final_final.textContent = final_total;
            ...
            if (text_code.value === "DISCOUNT25"){
              descuento = .25;
              console.log(descuento);
              label_descuento.textContent = "-25%";
              envio.textContent = envio_pago;
          let final_total = ((sub_total + envio_pago ) - ((sub_total + envio_pago )* descuento));
          final_final.textContent = final_total;
            }
            if (text_code.value === "DISCOUNT50"){
              descuento = .50;
              console.log(descuento);
              label_descuento.textContent = "-50%";
              envio.textContent = envio_pago;
          let final_total = ((sub_total + envio_pago ) - ((sub_total + envio_pago )* descuento));
          final_final.textContent = final_total;
            }
